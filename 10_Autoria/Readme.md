...
# Autoría y doble codificación

Esta carpeta contiene las evidencias correspondientes al proceso de autoría, las sesiones de trabajo, los aportes individuales, la doble codificación independiente y la verificación de los resultados del proyecto SICST.
...
Los aportes y commits históricos realizados antes de su salida, cuando existan, se conservan en el historial de Git y en el archivo .mailmap por transparencia, trazabilidad y respeto a la autoría original. No se han eliminado ni reasignado sus contribuciones.
